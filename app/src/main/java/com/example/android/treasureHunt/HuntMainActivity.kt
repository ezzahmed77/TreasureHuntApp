...
class HuntMainActivity : AppCompatActivity() {
    ...
    // Adding variable to check if the device running Q or later
 ...
 */
    ...
    */
    private fun addGeofenceForClue() {
        ...
        // This code will need to be deleted
     ...
     */
    @TargetApi(29)
    // This function checks on the foreground & background location
    // The 2 of them must be approved
    // If running before Q the background location already granted
    // but if runningQOrLater then we should check for permission
    ...
    private fun requestForegroundAndBackgroundLocationPermissions() {
        // If the foreground & background location approved return
        // If not request the permissions
        if (foregroundAndBackgroundLocationPermissionApproved())
            return
        // Here we make permission array of only ACCESS_FINE_LOCATION
        // but if the device runningQOrLater then we add ACCESS_BACKGROUND_LOCATION
        // to permissions array
        // then we have an array of permissions
